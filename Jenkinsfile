  ...
  stages{
    stage('Provisioning VM on Proxmox with Terraform'){
      steps{
       ...
       // withCredentials([usernamePassword(credentialsId: 'Proxmox', passwordVariable: 'xbXif4P82Q88iA==', usernameVariable: 'th_digirolamo@pve')]) {    
         ...
         // sh label: '', script: 'cd Provisioning; export PM_USER=th_digirolamo@pve; export PM_PASS=xbXif4P82Q88iA==; terraform apply  --auto-approve'
